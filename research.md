...
**Vegetation Spatial Patterns in Global Drylands.**  ![]({{ site.url }}{{ site.baseurl }}/images/respic/dx_BSC6.jpg){: style="width: 250px; float: right; margin: 0px 10px"} 
...
To better understand dryland spatial dynamics, we are developing new theories and models that explicitly include biocrust-plant interactions. Supported by [NSF-DEB](https://www.nsf.gov/div/index.jsp?div=DEB), our team (co-PIs: [Yufang Jin](https://lawr.ucdavis.edu/people/faculty/jin-yufang), [Rachata Muneepeerakul](https://abe.ufl.edu/people/faculty/rachata-muneepeerakul/), [Caroline A. Havrilla](https://drylandecology.com/who-we-are), and [Yu Zhang](https://www.linkedin.com/in/yu-zhang-7b4a0090/)) aims to build models that explain the broader diversity of vegetation patterns observed in real drylands. See [this recent paper](https://link.springer.com/article/10.1007/s10021-023-00898-2) for results to date.
