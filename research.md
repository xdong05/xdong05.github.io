...
<div style="display:flex; justify-content:center; gap:10px; margin:8px 0 0 0;">
  ...
  <img src="{{ site.url }}{{ site.baseurl }}/images/respic/transformer.png" style="height:200px;">
</div>
...
<span style="color:#777; font-size:0.92em;">
Funded by the
<a href="https://www.energy.gov/undersecretaryforscience/genesis-mission/genesis-mission">DOE GENESIS</a>
&nbsp;|&nbsp;
Partners:
